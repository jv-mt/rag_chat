...
Author: Thesis Guidance Chat Team
Dependencies: colorlog, pyyaml, logging
"""
...
def get_logger():
    ...
    """
    return logging.getLogger("tg_logger") if logging.getLogger("tg_logger").handlers else setup_logger()
...
if __name__ == "__main__":
    ...
    logger.critical("This is a CRITICAL message - should appear in bold red with white background")
